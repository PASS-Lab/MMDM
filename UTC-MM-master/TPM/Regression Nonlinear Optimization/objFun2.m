% object function of Gruop2 (7-12 years old bridges)
% S(t) = 9-0.001852*t^3+0.05429*t^2-0.5229*t;

function sumValue = objFun2(p)
...
for i=7:12
    ...
    S(i) = 9-0.001852*i^3+0.05429*i^2-0.5229*i;
